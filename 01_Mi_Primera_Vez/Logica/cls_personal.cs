            ...
            using (var conexion = cn.obtenerConexion())//1 llamo a la conexion con la base
            {
                ...
                using (var comando = new SqlCommand(cadena, conexion)) //3 ejecuto el comando 
                {
                    ...
                    {                      
                        ...
                        {
                            var personales = new dto_personal //7  creo un objeto dto_personal para asiganr lo que trae de la base de datos
                            {
                            ...
                            listapersonal.Add(personales); //8 agregar a la lista el objeto
                        }
                    }
                }
            }
